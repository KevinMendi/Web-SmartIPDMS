...
<script>
    ...
    export default {
        ...
        data: () => ({
            heading: 'Project Progress Monitoring Chart',
            subheading: 'Progress report of the projects registered presented via chart, numbers, and graphs.',
            icon: 'pe-7s-graph1 icon-gradient bg-happy-itmeo',
